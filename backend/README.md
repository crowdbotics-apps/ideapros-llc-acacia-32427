...
## Project Structure
    ...
    ├── ideapros_llc_acacia_32427  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_acacia_32427`
...
2. Clone this repo and `cd ideapros_llc_acacia_32427`
